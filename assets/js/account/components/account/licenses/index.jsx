...
function AccountLicenses() {
	...
	return (
		<>
			<AccountBodyHeader
				heading='Licenses'
				totalItems={accountState.customer.licenses.length}
			/>
		...
		<Table>
			<TableBody>
				<tr>
					<Td>Plan:</Td>
					<Td>
						{license.price_option_name.includes('Unlimited')
							? 'Agency - '
							: 'Solo - '}
						{license.price_option_name}
					</Td>
				</tr>
				<tr>
					<Td>Purchased:</Td>
				...
				<tr>
					...
					<Td extraCSS={StatusCSS(license.status)}>
						...
						{license.status === 'inactive'
							? ' (License is not added to any WordPress sites yet)'
							: null}
					</Td>
				</tr>
			</TableBody>
