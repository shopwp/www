			...
			<table>
				...
				<tr align="top">
					...
					<td class="controls">
						...
						<?php if ( has_a_client() ): ?>
							<span style="margin-top: 20px; color:red; margin-right: 80px; display: block">Limitation Reach. Max 1 Client. <a
									href="https://wp-oauth.com/platform/" target="_top">Upgrade to Pro</a>.</span>
						<?php else: ?>
