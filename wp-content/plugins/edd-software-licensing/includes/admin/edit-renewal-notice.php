...
?>
<h2><?php _e( 'Edit Renewal Notice', 'edd_sl' ); ?> - <a href="<?php echo admin_url( 'edit.php?post_type=download&page=edd-settings&tab=extensions&section=software-licensing' ); ?>" class="add-new-h2"><?php _e( 'Go Back', 'edd_sl' ); ?></a></h2>
<form id="edd-edit-renewal-notice" action="" method="post">
	...
	<p class="submit">
		...
		<input type="submit" value="<?php _e( 'Update Renewal Notice', 'edd_sl' ); ?>" class="button-primary"/>
	</p>
</form>
