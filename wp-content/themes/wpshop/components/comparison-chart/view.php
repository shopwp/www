<section class="component component-comparison-chart">
   ...
   <div class="component-intro">
      <h2 style="text-align: center;">Compare features in WP Shopify Pro</h2>
      <p style="max-width: 940px;margin: 0 auto;">WP Shopify comes in two version: WP Shopify and WP Shopify Pro. You can find the free version on the <a href="https://wordpress.org/plugins/wpshopify/" target="_blank">WordPress repository</a> and you can <a href="https://wpshop.io/purchase" target="_blank">purchase the Pro version here</a>. Compare the different features of each version below:</p>
   </div>
      ...
      <table>
         ...
         <tbody>
            <tr>
               ...
               <td class="cell cell-yes">✅</td>
               <td class="cell cell-yes">✅</td>
            </tr>
            <tr>
               <td><a href="https://docs.wpshop.io/#/getting-started/features?id=shortcodes" target="_blank">Shortcodes</a></td>
               <td class="cell cell-yes">✅</td>
               <td class="cell cell-yes">✅</td>
            </tr>
            <tr>
            ...
            <tr>
               <td><a href="https://docs.wpshop.io/#/getting-started/features?id=link-to-shopify" target="_blank">Link to Shopify</a></td>
               <td class="cell cell-yes">✅</td>
               <td class="cell cell-yes">✅</td>
            </tr>
