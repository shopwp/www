            ...
            .done(function(data) {
               ...
               if (data.code !== 200) {
                  ...
                  $(form)
                     ...
                     .append('<i class="fa fa-times-circle" aria-hidden="true"></i> ' + data.message.detail)
                  $(form)
                     .find('.spinner')
                  ...
                  $(form)
                     .find('.form-success')
                     .append('<i class="fa fa-check-circle" aria-hidden="true"></i> Success! Please check your email to finish signing up.')
                  $(form).addClass('is-submitted')

                  initMailinglistTracking()

                  jQuery('#mailinglist-email').val('')
                  jQuery('#mailinglist-email').blur()
               }
            })
