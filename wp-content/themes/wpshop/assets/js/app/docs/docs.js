import { getDoc } from '../ws/ws'

import { selectText, copyToClipboard } from '../utils/utils'

import { getDocsToken } from '../utils/utils-token'

import { initAccordions } from '../forms/forms'
...
function showDocContent(docContent) {
   jQuery('.main')
      .empty()
      .append(jQuery('<div class="doc-content-wrapper">' + docContent + '</div>'))
   Rainbow.color()
