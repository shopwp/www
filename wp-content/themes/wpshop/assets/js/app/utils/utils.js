...
function insertMessage(msg, type, oneway = false) {
   ...
   if (!oneway) {
      setTimeout(function() {
         jQuery('body > .msg.animated')
            .removeClass('fadeInDown')
            .animateCss('fadeOutUp', function() {
...
export { getUrlParams, showLoader, hideLoader, disableForm, enableForm, enable, disable, hasValue, reduceFormData, insertMessage, clearFormFields, selectText, copyToClipboard }
