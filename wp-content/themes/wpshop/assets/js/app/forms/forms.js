  ...
  $('#form-forgot-pass')
    ...
    .validate({
      ...
      submitHandler: async function(form) {
        ...
        if (email) {
          insertMessage(
            'An email as been sent! Please click the link to finish the password reset process.',
            'success'
          )
        } else {
    ...
    .validate({
      ...
      submitHandler: async function(form) {
        ...
        if (passwordReset) {
          ...
          insertMessage(
            "Sorry we couldn't reset your password. Please try again or email support for help.",
            'error'
          )
        }
