...
<div class="sidebar-inner docs">
  ...
  <div class="l-row">
    <a href="/" class="logo-wrapper">
      <img src="<?php the_field('theme_logo_docs', 'option'); ?>" alt="ShopWP Documentation" class="logo-header">
    </a>
  ...
  <nav class="docs-nav">
    ...
    <div class="l-row l-row-left">
      ...
      <a href="https://travis-ci.com/arobbins/wp-shopify-pro" class="docs-travis-build" target="_blank">
        <img src="https://travis-ci.com/arobbins/wp-shopify-pro.svg?token=FmC2p6cxqRrxLpZfViYm&branch=master" alt="ShopWP Travis CI Build Status">
      </a>
