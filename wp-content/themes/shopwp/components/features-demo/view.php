   ...
   <div class="row">
      ...
      <aside class="nav">
         <div class="nav-inner">
            ...
            <ul>
			   ...
			   <li>
                  <a href="#subscriptions">Subscriptions <span>(Pro only)</span></a>
               </li>
			   <li>
                  <a href="#next-image-on-hover">Next image on hover <span>(Pro only)</span></a>
               </li>
      ...
      <section class="features">
         ...
         <div id="cart-experience">
            ...
            <div class="short-description">
               <p>ShopWP comes with a built-in cart experience with a ton of options including cart terms, cart notes, and discount code functionality. We also provide a simple to use cart icon that you can add to any page, or directly to a WordPress menu.</p>
            </div>
            <div class="example">
         ...
         <div id="subscriptions">
            ...
            <div class="example">
               <?= do_shortcode('[wps_products title="Super awesome jacket" subscriptions="true" variant_style="buttons"]'); ?>
            </div>
         </div>
         ...
         <div id="next-image-on-hover">
            ...
            <div class="example">
               <?= do_shortcode('[wps_products title="Super awesome jacket" link_to="none" show_featured_only="true" images_show_next_on_hover="true"]'); ?>
            </div>
         </div>
